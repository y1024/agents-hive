...
> 状态：IMPLEMENTED / ARCHIVED，2026-05-07 按代码实现同步状态；本期代码项已完成，非阻塞 eval / 回退手册 follow-up 已转入 `TODOS.md`。  
...
### 已转入 TODOS.md 的非阻塞 follow-up(3 项)
...
- [x] P2/P3 LLM eval 与上线回退手册已转入 `TODOS.md`，不作为本期代码未完成项
